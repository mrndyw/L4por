    ...
    >
      ...
      >
        <div class="text-center mb-6">
          <h1 class="text-2xl sm:text-xl font-bold">Create your account</h1>
        </div>
        <form @submit.prevent="handleRegister">
          <div class="mb-4 relative">
            <label
              for="username"
              class="block text-gray-700 font-semibold mb-2 text-left text-sm sm:text-base"
              >Username</label
            >
            <input
              v-model="username"
          ...
          <div class="mb-4 relative">
            ...
            />
            <i
              class="fas fa-envelope absolute left-4 top-2/3 transform -translate-y-1/2 text-gray-500"
            ></i>
          </div>
          ...
          <div class="mb-6 relative">
            ...
            <i
              ...
              class="absolute right-4 top-2/3 transform -translate-y-1/2 text-gray-500 cursor-pointer"
            ></i>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleRegister() {
        ...
        // You can send data to the backend via an API call.
        console.log({
